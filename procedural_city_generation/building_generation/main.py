...
def main():
    ...
    for poly in polylist:
        ...
        if poly.poly_type == "road":
            ...
            floortexture = texGetter.getTexture('Floor', int(buildingheight))
            windowtexture = texGetter.getTexture('Window', int(buildingheight))
            walltexture = texGetter.getTexture('Wall', int(buildingheight))
            rooftexture = texGetter.getTexture('Roof', int(buildingheight))
            ...
            if housebool:
                ...
                windowheight_max = singleton.windowheight_max_not_house if singleton.windowheight_max_not_house != 0 \
                    else floorheight
                ...
                if element == 'b' or element == 'f':
                    ...
                    if ledgefactor == 1:
                        polygons.extend(roof(walls, roofwalls, currentheight, housebool, rooftexture,
                                             texGetter.getTexture("Roof", int(buildingheight))))
